...
tx=x'; Ldanych=Ldemp; NT=(max(tx)-min(tx))/4; FIh(1:Ldanych,1)=1; i=2; for(k=1:4) FIh(1:Ldanych,i)=sin(2*pi*k*tx/NT); i=i+1; FIh(1:Ldanych,i)=cos(2*pi*k*tx/NT); i=i+1; end
